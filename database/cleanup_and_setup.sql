-- WECON Database Cleanup and Setup Script
-- Execute this in your Supabase SQL Editor to clean up conflicting tables

-- =============================================
-- STEP 1: DROP CONFLICTING TABLES
-- =============================================

-- Drop conflicting PascalCase tables
DROP TABLE IF EXISTS "CheckInLog" CASCADE;
...
-- Drop the conflicting core tables (these conflict with WECON schema)
...
-- =============================================
-- STEP 3: ENSURE WECON SCHEMA EXISTS
-- =============================================
...
-- Create WECON tables (using IF NOT EXISTS for safety)
-- USERS TABLE
...
SELECT 'WECON Database setup complete! Tables created:' as status;
SELECT table_name 
FROM information_schema.tables 
WHERE table_schema = 'public' 
AND table_type = 'BASE TABLE'
