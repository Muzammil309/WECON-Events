...
import { Users, Calendar, Presentation, Lightbulb, Zap, Target } from 'lucide-react';
...
export default function ComprehensiveAbout() {
  ...
  return (
    <section 
      id="section-about"
      className="relative py-20 overflow-hidden bg-pattern-grid"
      style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative">
              ...
              {/* Orbiting Elements */}
              {[
                { icon: <Zap className="w-4 h-4" />, angle: 0, radius: 180 },
                { icon: <Target className="w-4 h-4" />, angle: 45, radius: 180 },
                { icon: <Users className="w-4 h-4" />, angle: 90, radius: 180 },
                { icon: <Presentation className="w-4 h-4" />, angle: 135, radius: 180 },
                { icon: <Calendar className="w-4 h-4" />, angle: 180, radius: 180 },
                { icon: <Lightbulb className="w-4 h-4" />, angle: 225, radius: 180 },
                { icon: <Zap className="w-4 h-4" />, angle: 270, radius: 180 },
                { icon: <Target className="w-4 h-4" />, angle: 315, radius: 180 }
              ].map((item, index) => {
                ...
                return (
                  <motion.div
                    key={index}
                    className="absolute w-8 h-8 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full flex items-center justify-center text-white"
                    style={{
                      left: '50%',
                      top: '50%',
                      marginLeft: '-16px',
